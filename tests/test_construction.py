...
class ConstructionTest(TestCase):
    ...
    def test_append_from_source(self):
        ...
        PID = src_msg['PID'][0]
        self.assertEqual(str(PID), 'PID|Field1|Component1^Component2|Component1^Sub-Component1&Sub-Component2^Component3|Repeat1~Repeat2')
        response.append(PID)
        self.assertEqual(str(response), 'MSH|^~\\&|\rMSA\rPID|Field1|Component1^Component2|Component1^Sub-Component1&Sub-Component2^Component3|Repeat1~Repeat2')
